...
function init() {
  ...
  if (searchBox) searchBox.addEventListener("input", debounce(renderCards, 150));
  ...
  const weakCatsHtml = catScores.length === 0 ? '' : `
    ...
    <div class="home-weak-cats">
      ${catScores.map(({ cat, avg, seenN, total }) => {
        ...
        return `<div class="home-weak-cat" onclick="setMode('fiches',document.querySelector('[data-mode=fiches]'));currentFilter='${cat}';renderCards()">
  ...
  el.innerHTML = `
    <div class="home-wrap">
      <div class="home-greeting">
        <h2 class="home-title">Bonjour 👋</h2>
      ...
      <div class="home-progress-card">
        <div class="home-ring">
          <svg width="72" height="72" viewBox="0 0 72 72">
            <circle cx="36" cy="36" r="${r}" fill="none" stroke="var(--border)" stroke-width="6" transform="rotate(-90 36 36)"/>
      ...
      <div class="home-actions">
        <button class="home-action primary" onclick="setMode('anki', document.querySelector('[data-mode=anki]'))">
        ...
        <button class="home-action" onclick="setMode('terminal', document.querySelector('[data-mode=terminal]'))">
          <div class="ha-icon">💻</div>
          <div class="ha-body"><div class="ha-title">Terminal</div><div class="ha-sub">10 scénarios guidés</div></div>
        </button>
      </div>
      <div class="home-stats">
        <div class="home-stat"><div class="home-stat-label">Fiches vues</div><div class="home-stat-value">${n}</div></div>
        <div class="home-stat"><div class="home-stat-label">Maîtrisées</div><div class="home-stat-value" style="color:var(--green)">${mastered}</div></div>
        <div class="home-stat"><div class="home-stat-label">Dues Anki</div><div class="home-stat-value" style="color:${due>0?"var(--red)":"var(--green)"}">${due}</div></div>
